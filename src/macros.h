...
#define QMC2_MACHINELIST_INDEX			0
...
#define QMC2_MACHINEINFO_INDEX			2
...
#define QMC2_EMUCONTROL_COLUMN_MACHINE		1
...
#define QMC2_DEVTYPE_PRINTOUT			10
#define QMC2_DEVTYPE_PUNCHTAPE			11
#define QMC2_DEVTYPE_QUICKLOAD			12
#define QMC2_DEVTYPE_SERIAL			13
#define QMC2_DEVTYPE_SNAPSHOT			14
#define QMC2_DEVTYPE_ROMIMAGE			15
#define QMC2_DEVTYPE_MIDIIN			16
#define QMC2_DEVTYPE_MIDIOUT			17
...
#define QMC2_OPTIONS_FE_MACHINELIST_INDEX	2
...
#define QMC2_SORTCRITERIA_MACHINENAME		5
...
#define QMC2_DYNAMIC_DOT_PATH			(qApp->arguments().indexOf("-config_path") >= 0 && qApp->arguments().indexOf("-config_path") + 1 <= qApp->arguments().count() ? qApp->arguments().at(qApp->arguments().indexOf("-config_path") + 1) : QMC2_DOT_PATH)
...
#define QMC2_PRINT_STRLST(l)			for (int i = 0; i < l.count(); i++) printf("%s[%d] = %s\n", #l, i, l[i].toUtf8().constData())
...
// rank/comment cache fill-up repsonses
